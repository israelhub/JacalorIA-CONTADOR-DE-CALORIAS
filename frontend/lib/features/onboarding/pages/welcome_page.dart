        ...
        body: SafeArea(
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              final bubbleLeft =
                  mascotBubbleWidth - bubbleWidth - AppSpacing.xs;
              final mascotBubbleHeight =
                  (bubbleTop + bubbleHeight) > mascotHeight
                  ? (bubbleTop + bubbleHeight)
                  : mascotHeight;
              final mascotBlockLeftShift = (contentWidth * 0.09).clamp(
                28.0,
                48.0,
              );
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    AnimatedSlide(
                      ...
                      child: SizedBox(
                        ...
                        child: const Image(
                          ...
                          image: AssetImage('assets/images/nome.webp'),
                          fit: BoxFit.contain,
                        ),
                      ),
                    ),
                    const SizedBox(
                      height:
                          (AppSpacing.huge * 2) + AppSpacing.sm + AppSpacing.xs,
                    ),
                    AnimatedOpacity(
                    ...
                    AnimatedOpacity(
                      ...
                      child: SizedBox(
                        ...
                        child: AppButton(
                          label: 'Começar',
                          onPressed: () {
                            context.pushSlidePage(const PersonalDataPage());
                          },
